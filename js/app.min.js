...
let slider_about = new Swiper(".clients__slider", {
  //   effect: "fade",
  //   autoplay: {
  //     delay: 3000,
...
let slider_products = new Swiper(".products__inner", {
  // observer: true,
  observeParents: true,
  slidesPerView: 5,
  spaceBetween: 0,
  ...
  // // Arrows
  navigation: {
    nextEl: ".products__arrows-right",
    prevEl: ".products__arrows-left",
  },
